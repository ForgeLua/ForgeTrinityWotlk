...
if(FORGE)
  message("* Build Forge LuaEngine  : Yes (default)")
  add_definitions(-DFORGE)
  add_definitions(-DFORGE_TRINITY)
  add_definitions(-DFORGE_EXPANSION=2)
else()
  message("* Build Forge LuaEngine  : No")
endif()
